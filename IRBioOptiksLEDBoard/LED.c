...
Measurements:
Measured clocks:
LEDBoard fSMCLK: 509827Hz
LEDBoard BlinkRate: 120.02Hz
LEDBoard BlinkSpeed: 0.004612s
LEDBoard Cycle Time: ? sec
*/
...
static const int LEDCounter = 4248;         //Set equal to (Divider*ClockSpeed)/BlinksPerSec)), ((1*509827Hz)/120)=4248
